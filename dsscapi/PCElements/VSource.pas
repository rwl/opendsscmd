...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
function TVsource.Edit(ActorID: Integer): Integer;
var
...
begin
  // continue parsing with contents of Parser
    ...
    ActiveCircuit[ActorID].ActiveCktElement := ActiveVSourceObj;
    ...
    begin
        ...
        begin
            ...
            case ParamPointer of
                ...
                2:
                    kVBase := Parser[ActorID].DblValue; // basekv
                3:
                    PerUnit := Parser[ActorID].DblValue; // pu
                4:
                ...
                7:
                    MVAsc3 := Parser[ActorID].DblValue; // MVAsc3
                8:
                    MVAsc1 := Parser[ActorID].DblValue; // MVAsc1
                9:
                    X1R1 := Parser[ActorID].DblValue; // X1/R1
                10:
                    X0R0 := Parser[ActorID].DblValue; // X0/R0
                11:
                    Isc3 := Parser[ActorID].DblValue;
                12:
                    Isc1 := Parser[ActorID].DblValue;
                13:
                ...
                26:
                    BaseMVA := Parser[ActorID].DblValue;
...
//=============================================================================
procedure TVsourceObj.RecalcElementData(ActorID: Integer);
var
...
//=============================================================================
procedure TVsourceObj.CalcYPrim(ActorID: Integer);
...
//=============================================================================
procedure TVsourceObj.GetVterminalForSource(ActorID: Integer);
...
function TVsourceObj.InjCurrents(ActorID: Integer): Integer;
...
//=============================================================================
procedure TVsourceObj.MakePosSequence(ActorID: Integer);
