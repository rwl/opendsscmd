...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
function TIsource.Edit(ActorID: Integer): Integer;
var
...
begin
  // continue parsing with contents of Parser
    ...
    ActiveCircuit[ActorID].ActiveCktElement := ActiveIsourceObj;
...
//----------------------------------------------------------------------------
function TIsource.Init(Handle: Integer; ActorID: Integer): Integer;
...
//----------------------------------------------------------------------------
procedure TIsourceObj.RecalcElementData(ActorID: Integer);
...
//----------------------------------------------------------------------------
procedure TIsourceObj.CalcYPrim(ActorID: Integer);
...
function TIsourceObj.GetBaseCurr(ActorID: Integer): Complex;
...
function TIsourceObj.InjCurrents(ActorID: Integer): Integer;
...
procedure TIsourceObj.GetCurrents(Curr: pComplexArray; ActorID: Integer);
...
procedure TIsourceObj.GetInjCurrents(Curr: pComplexArray; ActorID: Integer);
...
procedure TIsourceObj.MakePosSequence(ActorID: Integer);
begin
