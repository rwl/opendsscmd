...
begin
    ...
    OptionHelp[117] := 'Activates/Deactivates the extended version of the plot command for figures with the OpenDSS Viewer.';
    OptionHelp[118] := 'Returns Yes/No if the OpenDSS Viewer installation is detected in the local machine (Read Only)';
    ...
    OptionHelp[129] := 'Seed random function';
end;
//----------------------------------------------------------------------------
function DoSetCmd_NoCircuit: Boolean;  // Set Commands that do not require a circuit
//----------------------------------------------------------------------------
...
begin
    ...
    begin
        ...
        case ParamPointer of
            ...
            129:
                RandSeed := Parser[ActiveActor].IntValue;
        else
        begin
    ...
    begin
        ...
        case ParamPointer of
            ...
            2, 13:
                SetObject(Param);
            3:
                ActiveCircuit[ActiveActor].solution.DynaVars.intHour := Parser[ActiveActor].IntValue;
            4:
                ActiveCircuit[ActiveActor].solution.DynaVars.t := Parser[ActiveActor].DblValue;
            5:
            ...
            10:
                ActiveCircuit[ActiveActor].solution.NumberOfTimes := Parser[ActiveActor].IntValue;
            11:
                Set_Time;
            14:
            ...
            15:
                DefaultEditor := Param;     // 'Editor='
            16:
                ActiveCircuit[ActiveActor].solution.ConvergenceTolerance := Parser[ActiveActor].DblValue;
            17:
                ActiveCircuit[ActiveActor].solution.MaxIterations := Parser[ActiveActor].IntValue;
            19:
            ...
            22:
                ActiveCircuit[ActiveActor].NormalMaxVolts := Parser[ActiveActor].DblValue;
            23:
                ActiveCircuit[ActiveActor].EmergMinVolts := Parser[ActiveActor].DblValue;
            24:
                ActiveCircuit[ActiveActor].EmergMaxVolts := Parser[ActiveActor].DblValue;
            25:
                ActiveCircuit[ActiveActor].DefaultDailyShapeObj.Mean := Parser[ActiveActor].DblValue / 100.0;
            26:
                ActiveCircuit[ActiveActor].DefaultDailyShapeObj.StdDev := Parser[ActiveActor].DblValue / 100.0;
            27:
                with ActiveCircuit[ActiveActor] do
                begin
                    LoadDurCurve := Param;
            ...
            29:
                ActiveCircuit[ActiveActor].AutoAddObj.GenkW := Parser[ActiveActor].DblValue;
            30:
                ActiveCircuit[ActiveActor].AutoAddObj.GenPF := Parser[ActiveActor].DblValue;
            31:
                ActiveCircuit[ActiveActor].AutoAddObj.CapkVAR := Parser[ActiveActor].DblValue;
            32:
            ...
            35:
                ActiveCircuit[ActiveActor].UEWeight := Parser[ActiveActor].DblValue;
            36:
                ActiveCircuit[ActiveActor].LossWeight := Parser[ActiveActor].DblValue;
            37:
            ...
            45:
                ActiveCircuit[ActiveActor].GenMultiplier := Parser[ActiveActor].DblValue;
            46:
            begin
            ...
            48:
                DoSetAllocationFactors(Parser[ActiveActor].DblValue);
            49:
                ActiveCircuit[ActiveActor].PositiveSequence := InterpretCktModel(Param);
            50:
                ActiveCircuit[ActiveActor].PriceSignal := Parser[ActiveActor].DblValue;
            51:
                with ActiveCircuit[ActiveActor] do
                begin
                    PriceCurve := Param;
            ...
            60:
                EnergyMeterClass[ActiveActor].SaveDemandInterval[ActiveActor] := InterpretYesNo(Param);
            61:
            begin
            ...
            62:
                EnergyMeterClass[ActiveActor].DI_Verbose[ActiveActor] := InterpretYesNo(Param);
            63:
                ActiveCircuit[ActiveActor].CaseName := Parser[ActiveActor].StrValue;
            64:
                ActiveCircuit[ActiveActor].NodeMarkerCode := Parser[ActiveActor].IntValue;
            65:
                ActiveCircuit[ActiveActor].NodeMarkerWidth := Parser[ActiveActor].IntValue;
            66:
            ...
            70:
                DoSetCFactors(Parser[ActiveActor].DblValue);
            71:
                AutoShowExport := InterpretYesNo(Param);
            72:
                MaxAllocationIterations := Parser[ActiveActor].IntValue;
            73:
            begin
                DefaultBaseFreq := Parser[ActiveActor].DblValue;
                ActiveCircuit[ActiveActor].Fundamental := Parser[ActiveActor].DblValue;     // Set Base Frequency for system (used henceforth)
            ...
            75:
                ActiveCircuit[ActiveActor].SwitchMarkerCode := Parser[ActiveActor].IntValue;
            76:
                DaisySize := Parser[ActiveActor].DblValue;
            77:
                ActiveCircuit[ActiveActor].MarkTransformers := InterpretYesNo(Param);
            78:
                ActiveCircuit[ActiveActor].TransMarkerCode := Parser[ActiveActor].IntValue;
            79:
                ActiveCircuit[ActiveActor].TransMarkerSize := Parser[ActiveActor].IntValue;
            80:
            ...
            87:
                ActiveCircuit[ActiveActor].CapMarkerCode := Parser[ActiveActor].IntValue;
            88:
                ActiveCircuit[ActiveActor].RegMarkerCode := Parser[ActiveActor].IntValue;
            89:
                ActiveCircuit[ActiveActor].PVMarkerCode := Parser[ActiveActor].IntValue;
            90:
                ActiveCircuit[ActiveActor].StoreMarkerCode := Parser[ActiveActor].IntValue;
            91:
                ActiveCircuit[ActiveActor].CapMarkerSize := Parser[ActiveActor].IntValue;
            92:
                ActiveCircuit[ActiveActor].RegMarkerSize := Parser[ActiveActor].IntValue;
            93:
                ActiveCircuit[ActiveActor].PVMarkerSize := Parser[ActiveActor].IntValue;
            94:
                ActiveCircuit[ActiveActor].StoreMarkerSize := Parser[ActiveActor].IntValue;
            95:
                ActiveCircuit[ActiveActor].NeglectLoadY := InterpretYesNo(Param);
            96:
                ActiveCircuit[ActiveActor].MarkFuses := InterpretYesNo(Param);
            97:
                ActiveCircuit[ActiveActor].FuseMarkerCode := Parser[ActiveActor].IntValue;
            98:
                ActiveCircuit[ActiveActor].FuseMarkerSize := Parser[ActiveActor].IntValue;
            99:
                ActiveCircuit[ActiveActor].MarkReclosers := InterpretYesNo(Param);
            100:
                ActiveCircuit[ActiveActor].RecloserMarkerCode := Parser[ActiveActor].IntValue;
            101:
                ActiveCircuit[ActiveActor].RecloserMarkerSize := Parser[ActiveActor].IntValue;
            102:
                UpdateRegistry := InterpretYesNo(Param);
            103:
                ActiveCircuit[ActiveActor].MarkRelays := InterpretYesNo(Param);
            104:
                ActiveCircuit[ActiveActor].RelayMarkerCode := Parser[ActiveActor].IntValue;
            105:
                ActiveCircuit[ActiveActor].RelayMarkerSize := Parser[ActiveActor].IntValue;
            107:
     ...
     // themselves will be the parameter name to return
        ...
        begin
            ...
            case ParamPointer of
                ...
                1, 12:
                    AppendGlobalResult(ActiveCircuit[ActiveActor].ActiveCktElement.DSSClassName);
                2, 13:
                    AppendGlobalResult(ActiveCircuit[ActiveActor].ActiveCktElement.Name);
                3:
                ...
                5:
                    AppendGlobalResult(IntToStr(ActiveCircuit[ActiveActor].solution.Year));
                6:
                    AppendGlobalResult(Format('%-g', [ActiveCircuit[ActiveActor].solution.Frequency]));
                7, 18:
                ...
                14:
                    AppendGlobalResult(ActiveCircuit[ActiveActor].name);
                15:
                ...
                20:
                    AppendGlobalResult(Format('%-g', [ActiveCircuit[ActiveActor].LoadMultiplier]));
                21:
                ...
                25:
                    AppendGlobalResult(Format('%-g', [ActiveCircuit[ActiveActor].DefaultDailyShapeObj.Mean * 100.0]));
                26:
                    AppendGlobalResult(Format('%-g', [ActiveCircuit[ActiveActor].DefaultDailyShapeObj.StdDev * 100.0]));
                27:
                ...
                32:
                    case ActiveCircuit[ActiveActor].AutoAddObj.Addtype of
                        GENADD:
                ...
                40:
                    case ActiveCircuit[ActiveActor].Solution.Algorithm of
                        NORMALSOLVE:
                ...
                46:
                    AppendGlobalResult(ActiveCircuit[ActiveActor].DefaultDailyShapeObj.Name);
                47:
                    AppendGlobalResult(ActiveCircuit[ActiveActor].DefaultYearlyShapeObj.Name);
                48:
                ...
                52:
                    AppendGlobalResult(Format('%d', [ActiveCircuit[ActiveActor].ActiveCktElement.ActiveTerminalIdx]));
                53:
                ...
                56:
                    AppendGlobalResult(ActiveCircuit[ActiveActor].BusList.Get(ActiveCircuit[ActiveActor].ActiveBusIndex));
                57:
                    AppendGlobalResult(DataDirectory[ActiveActor]); // NOTE - not necessarily output directory
                58:
                    with ActiveCircuit[ActiveActor] do
                ...
                60:
                    if EnergyMeterClass[ActiveActor].SaveDemandInterval[ActiveActor] then
                        AppendGlobalResult('Yes')
                    else
                        AppendGlobalResult('No');
                61:
                ...
                62:
                    if EnergyMeterClass[ActiveActor].DI_Verbose[ActiveActor] then
                        AppendGlobalResult('Yes')
                    else
                        AppendGlobalResult('No');
                63:
                    AppendGlobalResult(ActiveCircuit[ActiveActor].CaseName);
                64:
                ...
                67:
                    if DSSExecutive[ActiveActor].RecorderON then
                        ...
                        AppendGlobalResult('No');
                68:
                    if EnergyMeterClass[ActiveActor].Do_OverloadReport then
                        AppendGlobalResult('Yes')
                    else
                        AppendGlobalResult('No');
                69:
                    if EnergyMeterClass[ActiveActor].Do_VoltageExceptionReport then
                        AppendGlobalResult('Yes')
                    else
                        AppendGlobalResult('No');
                70:
                ...
                74:
                    if ActiveCircuit[ActiveActor].MarkSwitches then
                        AppendGlobalResult('Yes')
                    else
                        AppendGlobalResult('No');
                75:
                ...
                95:
                    if ActiveCircuit[ActiveActor].NeglectLoadY then
                        AppendGlobalResult('Yes')
                    else
                        AppendGlobalResult('No');
                96:
                ...
                106:
                    AppendGlobalResult(Format('%-g', [ActiveCircuit[ActiveActor].Solution.Time_Solve]));
                107:
                    AppendGlobalResult(Format('%-g', [ActiveCircuit[ActiveActor].Solution.Total_Time]));
                108:
                    AppendGlobalResult(Format('%-g', [ActiveCircuit[ActiveActor].Solution.Time_Step]));
                109:
                    AppendGlobalResult(Format('%d', [CPU_Cores]));
                110:
                begin
                    if CPU_Cores < 64 then
                        AppendGlobalResult(Format('%-g', [CPU_Cores / 2]))
                    else
                        AppendGlobalResult(Format('%d', [CPU_Cores]));
                end;
                111:
...
{$ENDIF}
                ...
                121:
                    if ActiveCircuit[ActiveActor].Solution.SampleTheMeters then
                        AppendGlobalResult('Yes')
                    else
                        AppendGlobalResult('No');
                122:
            ...
            case ParamPointer of
                ...
                118:
                    if DSS_Viz_installed then
                        ...
                        AppendGlobalResult('No');
                129:
                    AppendGlobalResult(Format('%d', [RandSeed]));
            else
            begin
                DoSimpleMsg('You must create a new circuit object first: "new circuit.mycktname" to execute this Set command.', 301);
                Result := FALSE;  // Indicate that we could not process all set command
