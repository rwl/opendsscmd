    ...
    begin
        ...
        begin
            ...
            case ParamPointer of
                ...
                1:
                    NConds := Parser[ActorID].IntValue;  // Use property value to force reallocations
                2:
                    FNphases := Parser[ActorID].IntValue;
                3:
                    ActiveCond := Parser[ActorID].IntValue;
                4:
                begin
                ...
                5:
                    FX^[ActiveCond] := Parser[ActorID].DblValue;
                6:
                    FY^[ActiveCond] := Parser[ActorID].DblValue;
                7:
                begin
                ...
                begin
                    ...
                    if LineSpacingClass[ActorID].SetActive(FSpacingType) then
                    begin
            ...
            case ParamPointer of
                ...
                3:
                    if (ActiveCond < 1) or (ActiveCond > FNconds) then
                        DoSimpleMsg('Illegal cond= specification in Line Geometry:' + CRLF + Parser[ActorID].cmdstring, 10102);
                4, 13, 14:
                begin
