...
begin
    ...
    begin
        ActiveDSSObject[ActiveActor] := TTSDataObj.Create(Self, ObjName);
        Result := AddObjectToList(ActiveDSSObject[ActiveActor]);
    end;
end;

function TTSData.Edit(ActorID: Integer): Integer;
var
    ...
    begin
        ...
        begin
            ...
            case ParamPointer of
                ...
                1:
                    FDiaShield := Parser[ActorID].DblValue;
                2:
                    FTapeLayer := Parser[ActorID].DblValue;
                3:
                    FTapeLap := Parser[ActorID].DblValue;
            else
