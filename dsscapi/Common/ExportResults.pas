    ...
    try
        ...
        begin
            ...
            begin
                ...
                Write(F, Format('"%s", %g', [UpperCase(BusName), Buses^[i].kvbase * SQRT3]));
    ...
    begin
        ...
        if Assigned(ActiveCircuit[ActiveActor].ActiveCktElement) then
            ...
            begin
                ...
                for i := 1 to NValues do
                begin
                    Write(F, Format(', %g, %g', [Cabs(Iterminal^[i]), cdang(Iterminal^[i])]));
                end;
                Writeln(F);
            end
    end;
    ...
    begin
        ...
        if Assigned(ActiveCircuit[ActiveActor].ActiveCktElement) then
            ...
            begin
                ...
                for i := 1 to NValues do
                begin
                    Write(F, Format(', %g, %g', [Cabs(Vterminal^[i]), cdang(Vterminal^[i])]));
                end;
                Writeln(F);
            end
    end;
        ...
        if Assigned(ActiveCircuit[ActiveActor].ActiveCktElement) then
            ...
            begin
                ...
                begin
                    ...
                    Write(F, Format(', %g, %g', [S.re * 0.001, S.im * 0.001]));
                end;
                Writeln(F);
            end
    end;
                        ...
                        begin
                            ...
                            begin
                                for j := 1 to Yorder do
                                    Write(F, Format('%g, %g, ', [cValues^[i + (j - 1) * Yorder].re, cValues^[i + (j - 1) * Yorder].im]));
                                Writeln(F);
                            end;
                        end;
                end;
        ...
        begin
            ...
            begin
                ...
                begin
                    re := cVals[i].re;
                    im := cVals[i].im;
                    Writeln(F, Format('%d,%d,%g,%g', [row, col, re, im]));
                end;
            end;
        end
        else
